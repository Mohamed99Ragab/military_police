        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
             <ol class="breadcrumb font-z-25">
              ...
              <li class="breadcrumb-item active"> /  إضافة فرد</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select id="place" class="form-control select2" name="service_place_id" >
        ...
        if (serviceId) {
            $.ajax({
                ...
                success: function(data) {
                    $('#place').empty();
                    $('#place').append('<option value="">اختر مكان</option>');
