                  ...
                  <table  cellpadding="10" cellspacing="0" class="table table-striped table-bordered">
                      ...
                      <tbody>
                       ...
                       <tr>
                           ...
                           <td>{{ $service->notPresent }}</td>
                           <td>{{ $service->onVacation }}</td>
                           <td>{{ $service->onMission }}</td>
                           <td>{{ $service->absentStatus }}</td>
                           <td>{{ $service->inEscaped }}</td>
                           <td> {{ $service->onIllnessVacation }} </td>
                           <td>{{ $service->inJail }}</td>
                           <td>{{ $service->inCentralJail }}</td>
                           <td>{{ $service->inHospital }}</td>
                       </tr>
                   @endforeach
