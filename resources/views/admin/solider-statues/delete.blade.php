...
<div class="modal fade" id="delete-status{{$SoliderStatus->id}}">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">حذف حالة الفرد</h4>
        ...
        <div class="modal-body">
          ...
          <form action="{{ route('admin.soliderStatues.destroy',$SoliderStatus->id) }}" method="POST">
                @csrf
                @method('DELETE')
