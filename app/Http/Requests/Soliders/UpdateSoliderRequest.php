...
class UpdateSoliderRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'phone_number'=>'required|string|min:11|max:11|unique:soliders,phone_number,'.$this->id,
            'military_number'=>'required|string|min:13|max:13|unique:soliders,military_number,'.$this->id,
